...
function Banner() {
  ...
  return (
    <div className="relative top-0 ">
      <RandomBanner />
      <div className="relative  overflow-hidden object-cover xl:top-[-4em] ">
        <div
          className="opacity-20  bg-no-repeat h-[100em]  object-cover banner "
          style={{
            backgroundImage: `url("https://image.tmdb.org/t/p/w500${poster}")`,
          }}
        ></div>
        <div className="absolute text-[f8fafc] top-[42em] left-20 xl:top-[10em]  xl:left-6">
          <div className=" w-[32em]  xl:w-full xl:grid xl:gap-6  ">
            ...
            <div className="grid gap-2">
              ...
              <p className=" text-gray-300 xl:leading-[1.5em] ">
